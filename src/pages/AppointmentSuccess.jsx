      ...
      <div className="w-[450px] bg-white rounded-md p-7 shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
        ...
        <div className="bg-[#F8F8F8] p-[18px] mb-7">
          <div className="flex justify-between mb-[18px]">
            ...
            <strong className="text-lg">July 25, 2026</strong>
          </div>

          <div className="flex justify-between mb-0">
            <span className="text-gray-600 text-lg">Time</span>
            <strong className="text-lg">10:00 AM</strong>
          </div>
        </div>

        <div className="flex justify-between">
          <button className="w-[165px] h-[46px] bg-white border border-[#d6d6d6] font-semibold text-gray-900 cursor-pointer text-base">
            Book Another
          </button>

          <button className="w-[210px] h-[46px] bg-[#0088B0] border-none text-white font-semibold cursor-pointer text-base">
